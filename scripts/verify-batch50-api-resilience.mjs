...
assert.match(api,/408, 425, 429, 500, 502, 503, 504/); assert.match(api,/exponential|2 \*\* \(attempt - 1\)/); assert.match(api,/TypeError/); assert.match(api,/AbortController/); assert.match(api,/response\.ok/);
