...
for(const required of ["access, 'private'","useCache: false","authenticated-blob-get","Authorization: `Bearer ${token}`","BLOB_READ_WRITE_TOKEN"]){if(!source.includes(required))throw new Error(`Private Blob reader missing ${required}.`);}
