...
const reveal = buildShotDirection({ purpose: 'reveal', subjectType: 'vehicle' });
assert.equal(reveal.motion.type, 'slow-arc');
...
console.log('Shot direction confidence + role-motion verification: PASS');
