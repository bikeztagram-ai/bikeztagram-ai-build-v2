...
const checks = [
  ...
  'verify:batch57runtime','verify:batch57','verify:batch58audio','verify:batch58','verify:batch59','verify:batch60','verify:batch61','verify:batch62','verify:batch63','verify:batch64','verify:batch65','verify:batch66','verify:batch67','verify:batch68','verify:batch69'
];
