...
if (/runFeatureBrain\(\);\s*if\(featureStatus!==0\).*?break/s.test(runner)) failures.push('feature brain is terminal instead of resumable');
...
console.log('AutoBot continuous-loop contract PASS: bounded deterministic slices, bounded feature slices, repeated alternation, shared time budget, cycle ceiling, and audit evidence.');
