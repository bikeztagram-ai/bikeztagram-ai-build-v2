...
const hasTaskLevelDependencies=task=>Array.isArray(task.dependsOn)&&task.dependsOn.length>0;
if(hasTaskLevelDependencies(a)||hasTaskLevelDependencies(b)) throw new Error('Shakedown tasks must have no task-level dependencies.');
