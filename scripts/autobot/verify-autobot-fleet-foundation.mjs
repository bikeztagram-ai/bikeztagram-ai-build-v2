...
assert(Number.isInteger(registry.coordination?.maxConcurrentWorkers)&&registry.coordination.maxConcurrentWorkers>=1&&registry.coordination.maxConcurrentWorkers<=8,'fleet worker limit must remain bounded at eight');
if(live){
...
assert(productionSpecialists.length===8,'exactly eight verified specialist Builders are authorised by the current live gate');
