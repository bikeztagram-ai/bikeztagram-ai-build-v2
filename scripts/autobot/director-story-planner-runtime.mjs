...
const plannerFile='src/aiEditPlanner.js'; const directorFile='src/director.js';
const read=f=>fs.readFileSync(f,'utf8'); const write=(f,s)=>fs.writeFileSync(f,s); const run=f=>execFileSync(process.execPath,[f],{stdio:'inherit'});
let planner=read(plannerFile); let director=read(directorFile);
