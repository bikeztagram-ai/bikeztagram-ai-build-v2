...
const checks=[
 ...
 [planner.includes('function completedSpecialistTitles')&&planner.includes('builder/working/persistent')&&planner.includes('autobot-specialist-handoff.json'),'Planner must consume prior specialist handoffs/history so deterministic fallback cannot repeat the same objective across persistent cycles'],
