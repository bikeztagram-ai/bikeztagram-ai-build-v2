...
const checks=[
 ...
 [engine.includes('cycleBaseCommit:process.env.AUTOBOT_CYCLE_BASE_COMMIT||baseCommit')&&handoff.includes('cycleBaseCommit:process.env.AUTOBOT_CYCLE_BASE_COMMIT||base'),'recovery and final handoff must preserve the original cycle base separately from the immediate repair base'],
