...
const checks=[
 ...
 [read('builder/runner/aider-feature-brain.mjs').includes("specialist?['--no-git',`--edit-format=udiff`]")&&read('builder/runner/autobot-repair.mjs').includes("'--no-git'")&&!read('builder/runner/aider-feature-brain.mjs').includes("specialist?0:768`),'focused specialist Aider runs must disable repo-map/git scanning to avoid unnecessary repository context work'],
