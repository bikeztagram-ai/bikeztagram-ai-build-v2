...
assert.match(engine,/aider-repo-map-v6-bounded-learning/);
...
assert.ok(selfObjective.acceptance.some(x=>String(x).includes('bounded execution budget')),'objective must require bounded execution');
