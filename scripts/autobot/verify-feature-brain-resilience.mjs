...
const required = [
  ...
  [/Existing working-tree changes|preserve all existing working-tree changes/i, 'working-tree preservation instruction missing'],
  [/previous verified increments/i, 'progress context missing'],
  [/progress\[obj\.id\]/, 'incremental objective progress missing'],
  [/tools\s*=\s*\[/, 'Ollama tool definitions missing'],
  [/edit_file/, 'repository edit tool missing'],
  ...
  [/multi-turn|agentic|agent loop/i, 'agent loop marker missing'],
];
