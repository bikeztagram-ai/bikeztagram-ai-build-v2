...
for (const [pattern, message] of [
  ...
  [/NUM_CTX\s*=\s*3072/, 'bounded context missing'],
  [/NUM_PREDICT\s*=\s*240/, 'bounded output missing'],
  [/const maxEdits = 1/, 'single-edit budget missing'],
  [/const maxAttempts = 1/, 'single-attempt budget missing'],
  [/format:\s*schema/, 'JSON schema output missing'],
  [/search must match exactly once/, 'exact-match write guard missing'],
  [/placeholder edit rejected/, 'placeholder edit guard missing'],
