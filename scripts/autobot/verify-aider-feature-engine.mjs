...
const expectedObjectiveSchemaVersion=6;
...
const checks=[
 ...
 ['objective schema version is current',objectivesDocument.version===expectedObjectiveSchemaVersion],
...
console.log(`Aider feature-engine contract PASS: ${checks.length}/${checks.length}; protocol=${expectedProtocol}; mapTokens=${expectedMapTokens}; passes=${expectedPasses}; objectiveSchema=${expectedObjectiveSchemaVersion}`);
