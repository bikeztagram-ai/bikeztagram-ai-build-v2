...
const checks=[
 ...
 ['self-evolution runner subtree',runner.includes("file.startsWith('builder/runner/')")&&runner.includes("path.join(root,scopePrefix)")],
 ['product runner subtree',runner.includes("file.startsWith('src/')")&&runner.includes("scopePrefix?path.join(root,scopePrefix):root")],
