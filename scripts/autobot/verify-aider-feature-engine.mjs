...
const checks=[
 ...
 ['scoped Aider files',runner.includes('...files')&&runner.includes('scopedFiles(obj)')],
 ['reduced repo-map scope',runner.includes('--subtree-only')&&runner.includes('--map-tokens=1024')],
