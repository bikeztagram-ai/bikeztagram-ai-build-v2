...
console.log('AutoBot segment-chain contract PASS: checkpoint propagation, six-hour segment ceiling, authoritative runtime budget, non-canceling continuation, bounded recursion, and draft review boundary.');
