...
if (markers.some((marker) => marker.nearestBeat < 0 || marker.nearestBeat >= 4)) {
  throw new Error('Cue marker falls outside the project duration');
}
if (markers.some((marker) => marker.beatDistance > 0.5)) {
  throw new Error('Cue marker is too far from its nearest beat');
}
...
console.log('music-cue-intelligence: PASS');
