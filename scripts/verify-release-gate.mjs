...
const steps = [
  ...
  ['director-runtime-cues', 'npm run verify:cinematic-runtime-cues'],
  ['executable-cinematic-director', 'npm run verify:executable-cinematic-director'],
  ['subject-aware-direction', 'npm run verify:subject-aware-direction'],
  ['timeline-director-preservation', 'npm run verify:timeline-director-preservation'],
