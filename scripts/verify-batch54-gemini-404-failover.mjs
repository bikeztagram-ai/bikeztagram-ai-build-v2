...
assert.match(file,/momentLength<0\.5/); assert.match(file,/momentEnd-0\.5/); assert.match(file,/safeEndTime/); assert.match(file,/availableDuration/);
assert.match(file,/const duration=Math\.max\(0\.5,Math\.min\(4/);
