...
assert.equal(clamped.startTime, 9.95); assert.equal(clamped.duration, 0.5); assert.equal(clamped.speedStart, 1.75);
...
assert.equal(threshold.expectedSeconds, 5); assert.equal(threshold.minimumProgress, 0.995);
