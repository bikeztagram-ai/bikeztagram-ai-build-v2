...
const autobotChecks = ['verify:autobot-live-telemetry', 'verify:autobot-brain-registry', 'verify:autobot-fleet-foundation', 'verify:autobot-repair-bot', 'verify:autobot-qa', 'verify:autobot-reviewer', 'verify:autobot-reviewer-handoff', 'verify:autobot-specialist-builder', 'verify:autobot-specialist-handoff', 'verify:autobot-self-improvement'];
