...
for (const name of ['rendiv', 'webmotion', 'openreel-video-editor', 'localcut', 'dvir-drori/daw', 'ai-music/webdaw']) {
  assert.ok(registry.toLowerCase().includes(name.toLowerCase()), `missing research candidate: ${name}`);
}
