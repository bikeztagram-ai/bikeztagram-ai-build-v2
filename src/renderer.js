          ...
          try {
            ...
            await new Promise((resolveFrame) => {
              const frame = () => {
                ...
                if (video.ended) {
                  // The source has finished, but the edit timeline has not. Keep the
                  // last decoded frame visible until this cut's planned duration ends.
                  sourceEnded = true;
            ...
            video.pause();
            if (sourceEnded) {
              // Intentionally no seek/restart here: the last real frame is the
              // authoritative visual hold, avoiding a jump back to the clip start.
            }
          } finally {
