...
const ACTION_HINTS = [
  ...
  ['explode', 'impact', 'crash'], ['fly', 'soar', 'dive'], ['walk', 'approach', 'enter'], ['fight', 'attack', 'escape'], ['swerve', 'corner', 'lean', 'brake'], ['swerve', 'corner', 'lean', 'brake'], ['swerve', 'corner', 'lean', 'brake'], ['swerve', 'corner', 'lean', 'brake'], ['swerve', 'corner', 'lean', 'brake'],
];
