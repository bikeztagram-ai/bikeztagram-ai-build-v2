...
createRoot(document.getElementById('root')).render(<React.StrictMode><App /><OutputFormatEnhancer /><PromptSceneStudio /><MusicStudio /><MusicArrangementStudio /></React.StrictMode>);
