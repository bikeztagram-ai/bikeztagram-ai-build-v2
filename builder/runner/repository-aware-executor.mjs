...
if(!fs.existsSync(path.join(root,'builder/working')))fs.mkdirSync(path.join(root,'builder/working'),{recursive:true});
index();appendAudit('repository-aware-run-started',{minutes,units,repositoryIndex:true});
