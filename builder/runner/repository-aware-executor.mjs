...
function feature(){features++;const slice=Math.max(1,Math.min(10,Math.floor(left())));return run('builder/runner/repository-aware-feature-brain.mjs',[],{BUILDER_MAX_MINUTES:String(slice),AUTOBOT_FEATURE_PASSES:String(process.env.AUTOBOT_FEATURE_PASSES_PER_SLICE||2),LOCAL_AI_MODEL:process.env.LOCAL_AI_MODEL||'qwen3:4b-instruct-2507-q4_K_M'})}
