...
if(spawnSync('npm',['run','build'],{stdio:'inherit'}).status!==0)throw new Error('candidate QA build failed');
if(spawnSync('npm',['run','verify:autobot-product-quality-check'],{stdio:'inherit'}).status!==0)throw new Error('candidate QA product-quality failed');
