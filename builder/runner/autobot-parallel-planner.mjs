...
function validate(item,bot,seenTitles,seenFiles,inv,library){
  ...
  const objectives=objectivesFromLibrary(library);if(objectives.some(o=>String(o?.title||'').trim().toLowerCase()===p.title.toLowerCase()))throw new Error(`${bot.id}: planner repeated an existing objective title`);
